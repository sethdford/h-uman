...
static void open_nn(hu_graph_t **g, hu_memory_t **m) {
...
static void close_nn(hu_graph_t *g, hu_memory_t *m) {
    hu_memory_close(m, A());
    hu_graph_close(g, A());
}
...
static int64_t insert_trace(hu_memory_t *m, const char *goal,
