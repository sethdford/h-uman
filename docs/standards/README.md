...
| [modeled-person-module-shape.md](engineering/modeled-person-module-shape.md) | Canonical module shape for persona / cognition / behavior layers | Modeled-Person module changes     |
