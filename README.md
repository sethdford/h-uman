...
```
~511 KB binary · <30 ms startup · 3027+ tests · 50+ providers · 33 channels · 60+ tools · Pluggable everything
```
...
Tests:         3027 passing, 0 ASan errors
```
...
tests/ 96 test files, 3027 tests
