...
```
~500 KB binary · <30 ms startup · 2818 tests · 50+ providers · 33 channels · 73 tools · Pluggable everything
```
...
Tests:         2818 passing, 0 ASan errors
```
...
tests/ 91 test files, 2818 tests
