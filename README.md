...
<p align="center">
  ...
  <strong>~2565 KB binary. < 6 MB RAM. Boots in <30 ms. Runs on anything with a CPU.</strong>
</p>
...
```
~2565 KB binary · <30 ms startup · 14,011+ tests · 97 providers · 31 channels · 87 tools · Pluggable everything
```

### Features

- **Impossibly Small:** ~2565 KB static binary — no runtime, no VM, no framework overhead.
...
| **RAM** ¹         | —                                                | —                                           | < 10 MB                                        | < 5 MB                                                | **< 6 MB**        |
| **Binary Size** ¹ | ~28 MB (npm dist)                                | N/A (Python)                                | ~8 MB                                          | ~8.8 MB                                               | **~2565 KB**      |
...
```
Binary size:   ~2565 KB (MinSizeRel + LTO, all channels)
...
Test files: 840
Tests: 6374+
Binary: ~2565 KB (MinSizeRel + LTO, all channels)
Peak RSS: ~5.7 MB
