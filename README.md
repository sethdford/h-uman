...
```
~1506 KB binary · <30 ms startup · 3758+ tests · 50+ providers · 34 channels · 67+ tools · Pluggable everything
```
...
Tests:         3758 passing, 0 ASan errors
```
...
tests/ 128 test files, 3758 tests
