...
```
~511 KB binary · <30 ms startup · 2988+ tests · 50+ providers · 33 channels · 60+ tools · Pluggable everything
```
...
Tests:         2988 passing, 0 ASan errors
```
...
tests/ 96 test files, 2988 tests
