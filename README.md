...
```
~511 KB binary · <30 ms startup · 3,087+ tests · 50+ providers · 33 channels · 65+ tools · Pluggable everything
```
...
Tests:         3087 passing, 0 ASan errors
```
...
tests/ 96 test files, 3087 tests
