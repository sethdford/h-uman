...
```
~2468 KB binary · <30 ms startup · 14,311+ tests · 97 providers · 31 channels · 87 tools · Pluggable everything
```
...
Tests:         14,311 passing, 0 ASan errors
```
...
tests/ 580+ test files, 14,311+ tests
