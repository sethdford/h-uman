...
```
430 KB binary · <30 ms startup · 2,198 tests · 50+ providers · 24 channels · 54 tools · Pluggable everything
```
...
Tests:         2,198 passing, 0 ASan errors
```
...
tests/ 75 test files, 2,198 tests
