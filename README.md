...
```
~2468 KB binary · <30 ms startup · 13,903+ tests · 97 providers · 31 channels · 87 tools · Pluggable everything
```
...
Tests:         13,903 passing, 0 ASan errors
```
...
tests/ 580+ test files, 13,903+ tests
