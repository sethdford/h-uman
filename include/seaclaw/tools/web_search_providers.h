...
sc_error_t sc_web_search_duckduckgo(sc_allocator_t *alloc, const char *query, size_t query_len,
                                    int count, sc_tool_result_t *out);
...
sc_error_t sc_web_search_perplexity(sc_allocator_t *alloc, const char *query, size_t query_len,
                                    int count, const char *api_key, sc_tool_result_t *out);
