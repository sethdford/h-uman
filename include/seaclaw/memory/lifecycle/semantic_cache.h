...
sc_semantic_cache_t *sc_semantic_cache_create(
    sc_allocator_t *alloc, int ttl_minutes, size_t max_entries, float similarity_threshold,
...
sc_error_t
sc_semantic_cache_get(sc_semantic_cache_t *cache, sc_allocator_t *alloc, const char *key_hex,
