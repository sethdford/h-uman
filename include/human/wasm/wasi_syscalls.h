/* Minimal WASI syscall declarations for Human WASM build.
 * Matches wasi_snapshot_preview1 ABI.
 * Include only when __wasi__ is defined. */
#ifndef HU_WASI_SYSCALLS_H
#define HU_WASI_SYSCALLS_H
...
__wasi_errno_t __wasi_fd_read(__wasi_fd_t fd, const __wasi_iovec_t *iovs, size_t iovs_len,
                              __wasi_size_t *retptr0) HU_WASI_IMPORT("fd_read");
__wasi_errno_t __wasi_fd_write(__wasi_fd_t fd, const __wasi_ciovec_t *iovs, size_t iovs_len,
                               __wasi_size_t *retptr0) HU_WASI_IMPORT("fd_write");
__wasi_errno_t __wasi_fd_close(__wasi_fd_t fd) HU_WASI_IMPORT("fd_close");
__wasi_errno_t __wasi_path_open(__wasi_fd_t fd, __wasi_lookupflags_t dirflags, const char *path,
                                ...
                                __wasi_fd_t *retptr0) HU_WASI_IMPORT("path_open");
__wasi_errno_t __wasi_clock_time_get(__wasi_clockid_t id, __wasi_timestamp_t precision,
                                     __wasi_timestamp_t *retptr0) HU_WASI_IMPORT("clock_time_get");
__wasi_errno_t __wasi_random_get(uint8_t *buf, __wasi_size_t buf_len) HU_WASI_IMPORT("random_get");
__wasi_errno_t __wasi_environ_get(uint8_t **environ, uint8_t *environ_buf)
    HU_WASI_IMPORT("environ_get");
__wasi_errno_t __wasi_environ_sizes_get(__wasi_size_t *retptr0, __wasi_size_t *retptr1)
    HU_WASI_IMPORT("environ_sizes_get");
__wasi_errno_t __wasi_args_get(uint8_t **argv, uint8_t *argv_buf) HU_WASI_IMPORT("args_get");
__wasi_errno_t __wasi_args_sizes_get(__wasi_size_t *retptr0, __wasi_size_t *retptr1)
    HU_WASI_IMPORT("args_sizes_get");
_Noreturn void __wasi_proc_exit(__wasi_exitcode_t rval) HU_WASI_IMPORT("proc_exit");

#endif /* __wasi__ */

#endif /* HU_WASI_SYSCALLS_H */
