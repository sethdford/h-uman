#ifndef HU_WASI_BINDINGS_H
#define HU_WASI_BINDINGS_H
...
int hu_wasi_file_read_all(void *alloc_ctx, void *(*alloc_fn)(void *, size_t), int dir_fd,
...
/* Process */
_Noreturn void hu_wasi_proc_exit(int code);

#endif /* __wasi__ */

#endif /* HU_WASI_BINDINGS_H */
