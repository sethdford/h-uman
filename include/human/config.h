...
typedef struct hu_imessage_channel_config {
    ...
    /* US-43.3: enable the non-allowlisted courtesy reply path. Default true on
     * upgrade; operators who do not want any outbound to unknown senders can
     * set this false in config to disable the path system-wide. */
