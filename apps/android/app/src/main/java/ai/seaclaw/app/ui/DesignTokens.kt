...
object SCTokens {
    ...
    object Dark {
        ...
        val bgElevated = Color(0xFF1A1B1F)
        val bgInset = Color(0xFF0F1012)
        val bgOverlay = Color(0xFF202125)
        val bgSurface = Color(0xFF141518)
        val border = Color(0xFF27282D)
        val borderSubtle = Color(0xFF1A1B1F)
        ...
        val onAccentSecondary = Color(0xFF09090B)
        val onAccentTertiary = Color(0xFFFFFFFF)
        val pressedOverlay = Color(0x1AFFFFFF)
        val success = Color(0xFF10B981)
        val successDim = Color(0x2610B981)
        val text = Color(0xFFE4E5EB)
        val textFaint = Color(0xFF3F4046)
        val textMuted = Color(0xFF6B6D76)
    ...
    object Light {
        ...
        val bgElevated = Color(0xFFF4F4F7)
        val bgInset = Color(0xFFECECF0)
        val bgOverlay = Color(0xFFFFFFFF)
        val bgSurface = Color(0xFFFFFFFF)
        val bgWarm = Color(0xFFFAFAFB)
        val border = Color(0xFFD1D3D9)
        val borderSubtle = Color(0xFFF4F4F7)
        ...
        val text = Color(0xFF0F1012)
        val textFaint = Color(0xFF8E919A)
        val textMuted = Color(0xFF3F4046)
