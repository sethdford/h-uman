...
public enum SCTokens {
    ...
    public enum Dark {
        ...
        public static let bgElevated = Color(hex: 0x1A1B1F)
        public static let bgInset = Color(hex: 0x0F1012)
        public static let bgOverlay = Color(hex: 0x202125)
        public static let bgSurface = Color(hex: 0x141518)
        public static let border = Color(hex: 0x27282D)
        public static let borderSubtle = Color(hex: 0x1A1B1F)
        ...
        public static let onAccentSecondary = Color(hex: 0x09090B)
        ...
        public static let text = Color(hex: 0xE4E5EB)
        public static let textFaint = Color(hex: 0x3F4046)
        public static let textMuted = Color(hex: 0x6B6D76)
    ...
    public enum Light {
        ...
        public static let bg = Color(hex: 0xF8F8FA)
        public static let bgElevated = Color(hex: 0xF4F4F7)
        public static let bgInset = Color(hex: 0xECECF0)
        public static let bgOverlay = Color(hex: 0xFFFFFF)
        public static let bgSurface = Color(hex: 0xFFFFFF)
        public static let bgWarm = Color(hex: 0xFAFAFB)
        public static let border = Color(hex: 0xD1D3D9)
        public static let borderSubtle = Color(hex: 0xF4F4F7)
        ...
        public static let text = Color(hex: 0x0F1012)
        public static let textFaint = Color(hex: 0x8E919A)
        public static let textMuted = Color(hex: 0x3F4046)
