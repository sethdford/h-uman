...
static const hu_embedded_data_entry_t hu_embedded_data_registry[] = {
    {"agent/commitment_patterns.json", data_agent_commitment_patterns_json,
     &data_agent_commitment_patterns_json_len},
    {"daemon/courtesy_phrases.json", data_daemon_courtesy_phrases_json,
     &data_daemon_courtesy_phrases_json_len},
    {"agent/conversation_plan_words.json", data_agent_conversation_plan_words_json,
     &data_agent_conversation_plan_words_json_len},
    {"agent/input_guard_patterns.json", data_agent_input_guard_patterns_json,
     &data_agent_input_guard_patterns_json_len},
    {"agent/multistep_indicators.json", data_agent_multistep_indicators_json,
     &data_agent_multistep_indicators_json_len},
    {"agent/sentiment_words.json", data_agent_sentiment_words_json,
     &data_agent_sentiment_words_json_len},
    {"channels/telegram_commands.txt", data_channels_telegram_commands_txt,
     &data_channels_telegram_commands_txt_len},
    {"cognition/dual_process_words.json", data_cognition_dual_process_words_json,
     &data_cognition_dual_process_words_json_len},
    {"conversation/ai_disclosure_patterns.json", data_conversation_ai_disclosure_patterns_json,
     &data_conversation_ai_disclosure_patterns_json_len},
    {"conversation/backchannel_phrases.json", data_conversation_backchannel_phrases_json,
     &data_conversation_backchannel_phrases_json_len},
    {"conversation/contractions.json", data_conversation_contractions_json,
     &data_conversation_contractions_json_len},
    {"conversation/conversation_intros.json", data_conversation_conversation_intros_json,
    ...
    {"conversation/engage_words.json", data_conversation_engage_words_json,
     &data_conversation_engage_words_json_len},
    {"conversation/filler_words.json", data_conversation_filler_words_json,
     &data_conversation_filler_words_json_len},
    {"conversation/personal_sharing.json", data_conversation_personal_sharing_json,
     &data_conversation_personal_sharing_json_len},
    {"conversation/starters.json", data_conversation_starters_json,
     &data_conversation_starters_json_len},
    {"conversation/time_gap_phrases.json", data_conversation_time_gap_phrases_json,
     &data_conversation_time_gap_phrases_json_len},
    {"conversation/vulnerability_keywords.json", data_conversation_vulnerability_keywords_json,
     &data_conversation_vulnerability_keywords_json_len},
    {"eval/golden_set.jsonl", data_eval_golden_set_jsonl, &data_eval_golden_set_jsonl_len},
    {"memory/commitment_prefixes.json", data_memory_commitment_prefixes_json,
     &data_memory_commitment_prefixes_json_len},
    {"memory/emotion_adjectives.json", data_memory_emotion_adjectives_json,
     &data_memory_emotion_adjectives_json_len},
    {"memory/emotion_prefixes.json", data_memory_emotion_prefixes_json,
     &data_memory_emotion_prefixes_json_len},
    {"memory/relationship_words.json", data_memory_relationship_words_json,
     &data_memory_relationship_words_json_len},
    {"memory/topic_patterns.json", data_memory_topic_patterns_json,
     &data_memory_topic_patterns_json_len},
    {"personas/default.json", data_personas_default_json, &data_personas_default_json_len},
    {"persona/circadian_phases.json", data_persona_circadian_phases_json,
     &data_persona_circadian_phases_json_len},
    {"persona/relationship_stages.json", data_persona_relationship_stages_json,
     &data_persona_relationship_stages_json_len},
    {"prompts/autonomy_full.txt", data_prompts_autonomy_full_txt,
     &data_prompts_autonomy_full_txt_len},
    {"prompts/autonomy_readonly.txt", data_prompts_autonomy_readonly_txt,
     &data_prompts_autonomy_readonly_txt_len},
    {"prompts/autonomy_supervised.txt", data_prompts_autonomy_supervised_txt,
     &data_prompts_autonomy_supervised_txt_len},
    {"prompts/default_identity.txt", data_prompts_default_identity_txt,
     &data_prompts_default_identity_txt_len},
    {"prompts/group_chat_hint.txt", data_prompts_group_chat_hint_txt,
     &data_prompts_group_chat_hint_txt_len},
    {"prompts/persona_reinforcement.txt", data_prompts_persona_reinforcement_txt,
     &data_prompts_persona_reinforcement_txt_len},
    {"prompts/reasoning_instruction.txt", data_prompts_reasoning_instruction_txt,
     &data_prompts_reasoning_instruction_txt_len},
    {"prompts/safety_rules_compact.txt", data_prompts_safety_rules_compact_txt,
     &data_prompts_safety_rules_compact_txt_len},
    ...
    {"security/command_lists.json", data_security_command_lists_json,
     &data_security_command_lists_json_len},
    {NULL, NULL, NULL} /* Sentinel */
};

/* Derived from the table so adding an entry can never silently truncate the
 * scan (a hardcoded 39 here once dropped the last entry from lookups). */
static const size_t hu_embedded_data_count =
    sizeof(hu_embedded_data_registry) / sizeof(hu_embedded_data_registry[0]) - 1;
