...
hu_error_t hu_file_ingest_fetch(hu_allocator_t *alloc, hu_feed_ingest_item_t *items,
                                size_t items_cap, size_t *out_count) {
    (void)alloc;
    ...
    (void)strncpy(items[0].content, "AI agents are transforming software development workflows",
...
hu_error_t hu_file_ingest_fetch(hu_allocator_t *alloc, hu_feed_ingest_item_t *items,
    ...
    *out_count = 0;
    ...
    char dir_path[512];
    int n = hu_paths_state(dir_path, sizeof(dir_path), "feeds/ingest");
