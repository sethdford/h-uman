...
const sc_polling_descriptor_t *sc_channel_adapters_find_polling_descriptor(const char *channel_name,
                                                                           size_t len) {
    if (!channel_name)
        return NULL;
