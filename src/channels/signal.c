 ...
 *
 * GRADUATED in FIX 14. Production configs that set
 * `channels.signal.http_url` and `channels.signal.account` get the channel
 * spun up by `bootstrap.c`. Allow lists, group policy, and daemon-config
