...
description: AI model provider architecture in Human.
---

Human uses a **vtable-driven provider interface**. All AI model backends implement `sc_provider_t` and are selected by name at runtime.
