...
Human includes 80+ predefined compatible providers with default base URLs. You only need to set `api_key` and optionally `base_url`. See [Provider Overview](/providers/overview/) for the full list.
