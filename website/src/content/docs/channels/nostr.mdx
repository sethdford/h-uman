...
Human can send and receive Nostr direct messages using [nak](https://github.com/fiatjaf/nak) and the NIP-17 gift-wrapped DM format. Legacy NIP-04 encryption is also supported.
