...
MAX_BASELINE=14261   # src/daemon.c, measured 2026-07-18 after S2.1b follow-up-sched carve to src/daemon/daemon_followup_sched.c (-87 vs prior 14348). Lower as god-files are carved.
