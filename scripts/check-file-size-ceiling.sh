...
MAX_BASELINE=14237   # src/daemon.c, measured 2026-07-18: locked after tapback-band gate landed (+26) still below prior carve gains (was 14274). Lower as god-files are carved.
