...
MAX_BASELINE=14737   # src/daemon.c, measured 2026-05-31 post origin/main merge (B2 go-live reaction-pair capture wiring + main's E2 dedup). Phase E2 daemon carve-out lowers this.
