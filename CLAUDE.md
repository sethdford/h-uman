...
# Run tests (13,717+ tests, must be 0 failures, 0 ASan errors)
...
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| `ci.yml`                    | C build + 13,717+ tests (Linux + macOS), UI tsc + vitest + build, website build, clang-tidy, E2E, visual regression, axe accessibility, Lighthouse |
...
| `tests/`                          | 760+ test files, 13,717+ tests                                       |
