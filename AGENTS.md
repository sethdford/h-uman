...
Current scale: **2084 source + header files, ~445K lines of C, ~293K lines of tests, 14,311 tests, 31 channels**.
...
5. **All 14,311+ tests must pass at zero ASan errors**
...
src/
  ...
  channels/             67 channel implementations (cli, telegram, discord, slack, ...)
