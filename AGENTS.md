...
- minimal binary size (~2611 KB release with LTO)
...
Current scale: **2007 source + header files, ~426K lines of C, ~284K lines of tests, 14,011 tests, 31 channels**.
...
2. **Binary size and memory are hard product constraints**
   ...
   - Current release binary: ~2611 KB (all features with LTO).
...
5. **All 14,011+ tests must pass at zero ASan errors**
