...
Current scale: **2093 source + header files, ~433K lines of C, ~296K lines of tests, 14,406 tests, 31 channels**.
...
5. **All 14,406+ tests must pass at zero ASan errors**
...
src/
  ...
  channels/             68 channel implementations (cli, telegram, discord, slack, ...)
