...
Current scale: **1992 source + header files, ~484K lines of C, ~279K lines of tests, 13,735 tests, 31 channels**.
...
5. **All 13,735+ tests must pass at zero ASan errors**
...
src/
  ...
  channels/             63 channel implementations (cli, telegram, discord, slack, ...)
